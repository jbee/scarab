...
import static se.jbee.jar.TypeRef.typeRefsFromDescriptor;
...
public final class MethodRef {
	...
	public static MethodRef methodRefFromConstants( String declaringClass, String name, String type ) {
		...
		return new MethodRef( typeRef( declaringClass ),
				typeRef( type.substring( endOfParameters + 1 ) ), name,
				typeRefsFromDescriptor( type.substring( 1, endOfParameters ) ) );
	}
	...
	public MethodRef( TypeRef declaringClass, TypeRef returnType, String name,
