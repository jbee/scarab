...
public class PrintClassProcessor implements ClassProcessor {
	...
	@Override
	public void processClass(Type type, TypeRef extendsClass, TypeRef[] implementsInterfaces, References references) {
		process(type, extendsClass, implementsInterfaces, references);
	}

	private void process(Type type, TypeRef extendsClass, TypeRef[] implementsInterfaces, References references) {
		out.print(nr++);
		out.print("\t");
		out.print(type);
		out.print("\n");
